...
- **AI Orchestration**: Integrated **Google Gemini** to generate complex multi-file coding projects, technical reports (2000+ words), and presentations from a single prompt.
...
**Tech Stack:** Python, Streamlit, Gemini AI, Pandas, python-docx, python-pptx.
...
3. **Multi-LLM Support**:
   - Add a dropdown to switch between GPT-4, Claude 3, and Gemini based on user preference and budget.
